  ...
  <div className="flex max-w-6xl flex-col gap-y-16">
    ...
    <div className="flex flex-col-reverse items-center gap-[15vh] md:flex-row font-[Lato]">
      <div className="w-full text-center md:w-1/2 md:text-left">
        <h2 className="h-auto text-left text-5xl md:text-6xl font-bold font-[Fonarto] bg-gradient-to-r from-[#05a802] to-[#06D001] bg-clip-text text-transparent mb-10">
          Solução
        </h2>
    ...
    <div className="relative w-full overflow-hidden rounded-xl pt-[56.25%] border-3 border-[rgba(5,213,0,0.0)] 
    hover:border-[rgba(5,213,0,0.5)] transition-colors duration-300 ease-in-out
    shadow-md p-4" id="solucao">
      <iframe
